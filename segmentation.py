...
# store all information will be used in searching
searchInf = {}
...
class Segment():
    ...
    # grab the interrogative from the next questions that is used for keeping asking
    ...
    def expandPerson(self, questions):
        ...
        for named in words_low:
            if named in calls:
                ...
                # if words_org[spePerInd] not in searchInf.keys():
    ...
    def classes(self, questions):
        ...
        class_exp = r"[a-zA-Z]{0,4}[0-9]{3,6}"
